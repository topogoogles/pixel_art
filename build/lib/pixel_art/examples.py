...
def house():
  img = pixels.Image()
  img.add_row(0, 'cyan')
  img.add_row(1, 'cyan', 'yellow', 'cyan', 'cyan', 'red', 'cyan', 'cyan', 'cyan')
  img.add_row(2, 'cyan', 'cyan', 'cyan', 'red', 'red', 'red', 'cyan', 'cyan')
  img.add_row(3, 'cyan', 'cyan', 'red', 'red', 'red', 'red', 'red', 'cyan')
  img.add_row(4, 'cyan', 'cyan', 'red', 'red', 'red', 'red', 'red', 'cyan')
  img.add_row(5, 'cyan', 'cyan', 'white', 'white', 'white', 'white', 'white', 'cyan')
  img.add_row(6, 'cyan', 'cyan', 'white', 'white', 'black', 'white', 'white', 'cyan')
  img.add_row(7, 'green')
  img.display()
